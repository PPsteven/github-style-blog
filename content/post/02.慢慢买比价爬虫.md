...
![image-20210114113250055](/post/02.慢慢买比价爬虫/assets/img/image-20210114113250055.png)
...
![](/post/02.慢慢买比价爬虫/assets/img/image-20210114131939821.png)

## 请求分析

通过查看 `Requests Headers` 的头部信息，发现这是一个POST请求，只要把参数填入 `From data`即可。

![](/post/02.慢慢买比价爬虫/assets/img/image-20210114132139111.png)
...
![](/post/02.慢慢买比价爬虫/assets/img/image-20210114134237228.png)

### 请求头报文(Request Header)

![](/post/02.慢慢买比价爬虫/assets/img/image-20210114134630360.png)
...
![](/post/02.慢慢买比价爬虫/assets/img/image-20210114142147404.png)
...
![](/post/02.慢慢买比价爬虫/assets/img/image-20210114145805844.png)

然后，可以通过打上断点，查找发送数据的代码。但是这里并不是拼接数据的地方。

![](/post/02.慢慢买比价爬虫/assets/img/image-20210114150248508.png)

在 Call Stack 调用栈中，不断的向上排查，最终找到拼接数据的地方，可以看出 ajaxpost 这里是真正拼接数据的地方。

![](/post/02.慢慢买比价爬虫/assets/img/image-20210114150718545.png)

在调试中，找到了 `form data` 的数据

![](/post/02.慢慢买比价爬虫/assets/img/image-20210114151327739.png)
...
![](/post/02.慢慢买比价爬虫/assets/img/image-20210114152610556.png)

而且通过 `encode_version` 发现，这是使用 jsjiami.com 做的加密。

![](/post/02.慢慢买比价爬虫/assets/img/image-20210114152900610.png)
